//! Contains a [`RuleSet`] for allowing time-related syscalls,
//!   but check the comments for why you probably don't actually need to enable them.

use {
    extrasafe::{syscalls::Sysno, RuleSet},
